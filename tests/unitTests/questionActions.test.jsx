...
import {logOut, getAll, alert, login, register, postQuestion, getOne} from "../../src/actions/questionActions";

import { GET_ALL, LOGIN, LOGIN_FAIL, REGISTER, GET_ONE, GET_ONE_FAIL, POST, REGISTER_FAIL, POST_FAIL, LOG_OUT } from "../../src/actions/types";
